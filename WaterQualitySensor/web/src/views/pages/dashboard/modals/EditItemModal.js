...
import { editStation } from '../../../../functions/apiActions'
    ...
    this.setState(
      {
        ...
        loading: false,
        location: {
          lat: parseFloat(this.props.station.location.lat),
          long: parseFloat(this.props.station.location.long),
        },
      },
      () => {
        this.handleGeocodeFromLatLng({
          lat: parseFloat(this.state.station.location.lat),
          lng: parseFloat(this.state.station.location.long),
        });
      }
    );
  }
      ...
      >
        ...
        <ModalBody className="d-flex flex-column d-flex">
          ...
          <InputGroup className="m-1">
            ...
            <Input disabled placeholder="ไอดี" value={this.state.station.station_id} onChange={
              e => {
                /*let value = e.target.value
                this.setState(prevState => {
                  return {
        ...
        <ModalFooter className="border-0">
          <Button className="border-0 rounded-pill" onClick={this._handleEditStation}>
            บันทึก
          </Button>
          <Button
